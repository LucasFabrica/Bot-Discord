...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
var firebaseConfig = {
    apiKey: "AIzaSyAVa_Re5DKI92w2T90l2aJiqtsSQNbq-Z8",
    authDomain: "brooklyn-e8837.firebaseapp.com",
    databaseURL: "https://brooklyn-e8837.firebaseio.com",
    projectId: "brooklyn-e8837",
    storageBucket: "brooklyn-e8837.appspot.com",
    messagingSenderId: "962358151271",
    appId: "1:962358151271:web:8b051e3098d4516a8f6cc2",
    measurementId: "G-SERE7V2SVH"
  };
// Initialize Firebase
...
if(dados.t === "MESSAGE_REACTION_ADD"){
    if(dados.d.user_id === `722260952950767657`)return
    let servidor = client.guilds.get("712084835795206174")
    let membro = servidor.members.get(dados.d.user_id)
    let canal1 = servidor.channels.get('713600235045257258')
        if(dados.d.emoji.id === "722213216301744161"){
            if(dados.d.message_id != "722283960482398269") return 
...
////////////// TERMINOU WL PONT MAXIMA
    ...
    if(dados.t == 'MESSAGE_CREATE'){
        if(dados.d.author.id == '722260952950767657') return;
        ...
        if(msg == '!historia'){
            let servidor = client.guilds.get(`722260952950767657`)
                    ...
                    if(snap3.val().cont === 16){
                        if(dados.d.guild_id === undefined){
                            if(snap3.val().xp >= 10){
                                ...
                                .setFooter(` Bom jogo! `)
                                membro.send(embed12) 
                                let cargof = servidor.roles.get('721835541452292157')
                                let cargoh = servidor.roles.get('722221412747837471')
                                membro.addRole(cargof)
        ...
        let canal12 = servidor.channels.get(`722286904133025902`)
  

        if(msge == '!hs'){
            if(dados.d.channel_id == `722260952950767657`){
                database.ref(`user/${dados.d.author.id}`)
                  .once('value').then(async function(snap){
